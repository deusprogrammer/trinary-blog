...
import com.trinary.test.controller.v1.UserController;
...
public class UserResourceAssemblerV1 extends ResourceAssemblerSupport<User, UserResource> implements UserResourceAssembler {

	public UserResourceAssemblerV1() {
	...
	public UserResource toResource(User user) {
		...
		resource.add(linkTo(methodOn(UserController.class).getBlogs(user.getId())).withRel("blogs"));
		resource.add(linkTo(methodOn(UserController.class).getComments(user.getId(), null, null)).withRel("comments"));
		return resource;
	}
